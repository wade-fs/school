...
import com.wade.school.data.local.entity.ClassroomPerformance
import com.wade.school.data.local.entity.LearningMaterial
import com.wade.school.data.local.entity.LessonPlan
...
class SubjectTeacherViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val periodTimes: StateFlow<List<com.wade.school.data.local.entity.PeriodTime>> = dao.getPeriodTimes()
        .stateIn(viewModelScope, SharingStarted.WhileSubscribed(5000), emptyList())
